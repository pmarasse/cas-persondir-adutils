...
public class TokenGroupsToAttributeProcessorTest {
    ...
    public final static String              TOKEN_GROUPS_NO_GC = "tokenGroupsNoGCAcceptable";
    ...
    public void globalSetUp() throws Exception {
        ...
        env.put("java.naming.ldap.attributes.binary", TOKEN_GROUPS + " " + TOKEN_GROUPS_NO_GC);
        ...
        queriedAttributes.add(TOKEN_GROUPS);
        queriedAttributes.add(TOKEN_GROUPS_NO_GC);
        ...
        processor.setSourceAttribute(TOKEN_GROUPS);
        ...
        personAttributeDao.setFetchDirectDn(true);
    ...
    public void RealTest() {
        ...
        /*
         * Groups expected : cn=Utilisateurs,cn=Builtin,dc=in,dc=archigny,dc=org, cn=Groupe local
         * indirect,ou=Groupes,dc=in,dc=archigny,dc=org, cn=groupe indirect,ou=Groupes,dc=in,dc=archigny,dc=org, cn=Utilisateurs du
         * domaine,cn=Users,dc=in,dc=archigny,dc=org, cn=groupe direct,ou=Groupes,dc=in,dc=archigny,dc=org]
         */
    ...
    public void RealTestNoGC() {
        ...
        processor.setSourceAttribute(TOKEN_GROUPS_NO_GC);
